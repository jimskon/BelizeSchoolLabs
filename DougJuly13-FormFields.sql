...
INSERT INTO form_fields (table_name, field_name, prompt, type, valuelist, field_width, required, visible) VALUES
	...
	('school_info',		'year_opened',					'Year School Opened',							'num',			'1850,2025',6,0,1),
	...
	('curriculum',		'other_online_local_education_tools','Other educational websites?',											'text', 	NULL,		6,0,1),
	('curriculum',		'formal_curriculum',			'What formal computer related curriculum does your school use if any?',		'text',		NULL,		6,0,1),
	('curriculum',		'local_curriculum',				'What locally generated computer related curriculum does your school use?',	'dropdown',	'Made by a local teacher, Made by our management, From an online book, We do not have a locally generated curriculum, Our teachers create their own, other', 6,0,1),
	...
	('curriculum',		'admin_comments',				'Comments for admin (only seen by the admin)',								'text',		NULL,		12,0,1),

	-- Future curriculm

	('future_curriculum','keyboarding',				'Would your school teach general keyboarding?',									'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','computer_literacy',		'Would your school  teach computer literacy?',									'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','word',					'Would your school teach word processing, such as Microsoft Word, LibreOffice/OpenOffice Write, or Google Docs?',	'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','spread_sheet',			'Would your school teach spreadsheets such as Excel, LibreOffice Calc, or Google Sheets?',				'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','data_base',				'Would your school teach about databases such as MS Access, LibreOffice Base, MySQL?',					'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','slide_show',				'Would your school teach slide show design, such as: PowerPoint, LibreOffice Present, Google Slides?',	'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','google_workspace',		'Would your school also teach Google Workspace, such as Google Docs, Sheets, etc.?',					'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','software_suite',			'Which software suite would your school prefer?', 'dropdown','Do not know,Microsoft Office,LibreOffice,OpenOffice,Google WorkSpace,Both Office and Workspace',6,0,1),

	('future_curriculum','cloud_based_learning_tools','Would your school use other learning websites such as typing, spelling, math, etc.?',				'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','graphics_design',			'Would your school teach graphics design tools such as Photoshop, Illustrator, Publisher, Canva, PosterMyWall, or equivalent?',					'dropdown',		'Yes,No',	6,1,1),

	('future_curriculum','graphics_animation',		'Would your school teach graphics animation such as Blender, SketchUP, or equivalent?',					'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','graphics_cad_program',	'Would your school teach graphics CAD tools such as AutoCad or equivalent?',							'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','robotics',				'Would your school teach robotics?',											'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','code_dot_org',			'Would your school use code.org',												'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','khan_accadamy',			'Would your school use Khan Academy or similar online learning platforms?',		'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','edpm',					'Would your school use EDPM?',													'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','other_online_local_education_tools',	'What other Website tools would your school use or teach?',			'text', 		NULL,		6,0,1),
	('future_curriculum','formal_curriculum',		'What formal computer-related curriculum would your school use, if any? ',		'text', 		NULL,		6,0,1),
	('future_curriculum','local_curriculum',		'What locally generated computer-related curriculum would your school use',		'dropdown',		'Made by a local teacher, Made by our management, From an online book, We do not have a locally generated curriculum, Our teachers create their own, other', 6,0,1),
	('future_curriculum','rachel_server',			'Would your school participate in the Rachel server project?',					'dropdown',		'Yes,No',	6,1,1),
	('future_curriculum','other',					'What other computer related teaching tools would your school use that were not mentioned above?','text', NULL,	12,0,1),
	('future_curriculum','comments',				'Do you have any comments about the above information',							'text',			NULL,		12,0,1),
	('future_curriculum','admin_comments',			'Comments for admin (only seen by the admin)',									'text',			NULL,		12,0,1),	

	-- computerRoom

	('computerRoom',	'number_seats',				'How many student computer stations can your computer room accommodate?',					'num',			'0,10',		6,1,1),
	...
	('computerRoom',	'admin_comments',			'Comments for admin (only seen by the admin)',												'text',			NULL,		12,0,1),


	-- future computer room

	('future_computerRoom',	'number_seats',			'How many student computer stations can your future computer room accommodate?',					'num',			'0,10',		6,1,1),
	('future_computerRoom',	'wired_for_lab',		'Has your future computer room been wired expressly for a computer lab?',							'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'electrical',			'Does your future computer room have a dedicated electrical service panel in the computer room?',	'dropdown',		'Yes,No', 	6,1,1),
	('future_computerRoom',	'electrical_ground',	'Is there a quality ground wire connected to a ground rod?',										'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'electrical_outlets',	'How many electrical outlets are in the future computer room?',										'num',			'0,10',		6,1,1),
	('future_computerRoom',	'air_condition',		'How many working air conditioners does your future computer lab have?',							'num',			'0,2',		6,1,1),
	('future_computerRoom',	'partition_security',	'Are all 4 walls in your future computer room concrete including the partition to the next room?',	'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'ceiling_secure',		'Is your future computer lab ceiling constructed of concrete or steel with no open spaces and secured from a thief climbing over the partitioned wall?','dropdown','Yes,No',6,1,1),
	('future_computerRoom',	'windows_secure',		'Are all the windows removed and blocked, or have strong burglar bars installed?',					'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'lighting',				'Is the lighting in your future computer room sufficient (even when all windows are blocked)?',		'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'location',				'Is your future computer room located at the end of your building (i.e. with 3 outside walls)?',	'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'location_floor',		'Is your future computer room located on the first floor?',											'dropdown',		'Yes,No',	6,1,1),
	('future_computerRoom',	'comments',				'Do you have any comments about the above information',												'text',			NULL,		12,0,1),
	('future_computerRoom',	'admin_comments',		'Comments for admin (only seen by the admin)',														'text',			NULL,		12,0,1),
